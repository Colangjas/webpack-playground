...
function component1() {
  ...
  var element = document.createElement('div'); // First "scoped" element variable
  var element2 = document.createElement('div'); 
  // Second element variable in same scope. This needs to be named 'element2'

  // Lodash, now imported by this script
  element2.innerHTML = _.join(['Hello', 'webpack', '. This is the component1 function :D'], ' ');
...
function component2(globalElement) {
  // Element variable is called in both component1() and component2() functions
  var element = document.createElement('div'); // Second "scoped" element variable
  ...
  /*
   ...
   don't need to be escaped when using eiter single or double quotes
  */
